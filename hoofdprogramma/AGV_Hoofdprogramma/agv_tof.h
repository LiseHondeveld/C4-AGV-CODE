#ifndef AGV_TOF_H_INCLUDED
#define AGV_TOF_H_INCLUDED

#define ToF_Def_addr 0xEE

#define ToF_Front_Shutx
#define ToF_Front_GPIO
#define ToF_Front_addr 0x

#define ToF_Back_shutx
#define ToF_Back_GPIO
#define ToF_Front_addr 0x
